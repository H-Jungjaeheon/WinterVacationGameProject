...
public class BattleFinalBoss : BattleBasicEnemy
{
    ...
    [SerializeField] bool IsSuperAnger, IsFarAway;
    [SerializeField] int RandBasicAttack, RandSkill, PoisonCount, SuperAnger; //(기본 공격 랜덤, 스킬 공격 랜덤, 독 공격 카운터, 체력 흡수 카운터
    [SerializeField] GameObject HealText; //체력 회복 텍스트
    public Image SuperAngerBar, InstantDeathBar, MaxInstantDeathBar; //각성 바, 즉사 패턴 바(빈 즉사 패턴 바) 
