...
public class GameManager : MonoBehaviour
{
    ...
    public bool IsBattleStart = false, IsCamMove = false, AttackOk = false, IsBattlePlace = false, isPause, isRoom, LevelUp = false, isGetKey=false, isManaBarrier,isEunsin = false, isTrapBarrier=false , isBurns=false; //전투 시작, 전투 카메라 이동, 공격 가능, 전투 장소 띄우기 여부 판단, 플레이어 열쇠 여부
